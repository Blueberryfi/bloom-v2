...
/**
 * @title IBloomRouter
 * @notice Interface for Bloom V2's Router
 */
interface IBloomRouter {
    /*///////////////////////////////////////////////////////////////
                            Structs
    //////////////////////////////////////////////////////////////*/
    ...
    /// @notice Returns whether a given address is a valid bloom pool.
    function isPool(address pool) external view returns (bool);

    /// @notice Returns the address of the BloomPool for a given TBY id.
    function poolFromTbyId(uint256 id) external view returns (address);
}
